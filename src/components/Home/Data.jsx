...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Rafael Guilherme
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I am a Front-end developer with 2 years of experience in companies of different segments, from startups to big techs.</p>
    </div>
  )
}
